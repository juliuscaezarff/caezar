...
In theory, aligning two things is simple. You place one next to the other, set the same paddings, the same distance, the same size, and you are done. But anyone who works with interfaces knows that it is not that straightforward. Sometimes everything is mathematically perfect, and it still looks wrong.
